...
*	@author ftian
*/
class ConsumController extends BaseController{
	/**
	 * 管理员信息列表
	 */
	...
	{	
		...
		$array['delSelect'] = 'no';
		$array['disSelect'] = 'no';
		$array['url'] = U("Admin/Consum/showlist");
		$array['fields'] = array('id'=>'编号','created'=>'创建时间');
		//设置分页参数
		...
		$ConsumModel = D('Consum');
        $result = $ConsumModel->showList($search,$pages);
