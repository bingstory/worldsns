...
function check_username(){
    ...
    if (username == "") {
      	...
      	document.getElementById('username_error').innerHTML = register_input_name;
	  	...
	  	return false;
       	...
       	if (/^\w{0,20}$/.test(username)) {
			...
			//document.getElementById('username_error').style.display="block";
        	document.getElementById('username_error').innerHTML = register_input_name_e;
			document.getElementById("username").value="";
...
var check_email=function (){
	var email;
 	...
 	if (email == "") {
  		...
  		document.getElementById('email_error').innerHTML = register_input_email;
  		...
  		return false;
   		...
   		if (/^[\w-]+[\.]*[\w-]+[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/.test(email)) {
			...
			//document.getElementById('email_error').style.display="block";
    		document.getElementById('email_error').innerHTML = checkEmailmyreg;
			document.getElementById("email").value="";
...
var FPcheck_email=function (){
	var email;
 	...
 	if (email == "") {
 		...
 		document.getElementById('FPemail_error').innerHTML = register_input_email;
  		...
  		return false;
   		...
   		if (/^[\w-]+[\.]*[\w-]+[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/.test(email)) {
			...
			//document.getElementById('FPemail_error').style.display="block";
    		document.getElementById('FPemail_error').innerHTML = checkEmailmyreg;
			document.getElementById("FPemail").placeholder="";
			alert(checkEmailmyreg);
			return false;
    	}      
...
var check_pass=function (){
	...
	if (pass == "") {
		...
		document.getElementById('pass_error').innerHTML = register_input_psw;
	   ...
	   if (/^\w{0,20}$/.test(pass)) {
			...
			//document.getElementById('pass_error').style.display="block";
	    	document.getElementById('pass_error').innerHTML = register_input_name_e;
			document.getElementById("password").value="";
			alert(register_input_name_e);
			return false;
    	}      
...
var page_register=function(user){
	...
	document.getElementById("reg_header").innerHTML=Register;
...
var InsertExpressionText =function(ExpressionText){
	...
	if(ExpressionText=="[Smile]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face1.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Grimace]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face2.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Drooling]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face3.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Scowl]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face4.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Chill]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face5.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sob]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face6.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Shy]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face7.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Silence]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face8.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Cry]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face9.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Embarrassed]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face10.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[On fire]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face11.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Wink]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face12.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Grin]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face13.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Surprised]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face14.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sad]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face15.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Cool]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face16.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Frightened]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face17.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Scream]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face18.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Puke]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face19.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Chuckle]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face20.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Lovely]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face21.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sneer]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face22.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Arrogant]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face23.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Hungry]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face24.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Drowsy]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face25.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Panic]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face26.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sweating]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face27.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Laugh]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face28.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Soldier]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face29.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Strive]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face30.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Scold]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face31.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Confused]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face32.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Shhh]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face33.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Hypnotized]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face34.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Torment]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face35.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Frustrated]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face36.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Skull]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face37.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Hammer]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face38.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Wave/Bye]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face39.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Relived]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face40.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Pick nose]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face41.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Applause]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face42.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Flushed]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face43.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Hellooo]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face44.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Snub1]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face45.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Snub2]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face46.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Yawn]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face47.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Booo]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face48.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Distressed]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face49.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sniffle]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face50.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Sly]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face51.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Pucker]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face52.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Scared]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face53.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Pathetic]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face54.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Petrified]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face55.gif' class='gwx_face_face'>";
	}else if(ExpressionText=="[Speechless]"){
		Expressionimg="<img src='Public/Wap/Images/faces/face56.gif' class='gwx_face_face'>";
	}else{
...
var formatDate = function (d, mask) {
	...
	var languagebotton=function(langs){
		if(langs=="zh"){
			document.getElementById("language_title").innerHTML="简体中文";	
			document.getElementById("language_jianti").innerHTML="简体中文";			
		}else if(langs=="tw"){
			document.getElementById("language_title").innerHTML="中文-繁體";	
			document.getElementById("language_jianti").innerHTML="中文-繁體";		
		}else if(langs=="en"){
			document.getElementById("language_title").innerHTML="English";
			document.getElementById("language_jianti").innerHTML="English";			
		}else if(langs=="ja"){
			document.getElementById("language_title").innerHTML="日本語";	
			document.getElementById("language_jianti").innerHTML="日本語";		
		}else if(langs=="ko"){
			document.getElementById("language_title").innerHTML="한국의";	
			document.getElementById("language_jianti").innerHTML="한국의";		
		}else if(langs=="de"){
			document.getElementById("language_title").innerHTML="Deutsch";	
			document.getElementById("language_jianti").innerHTML="Deutsch";		
		}else if(langs=="es"){
			document.getElementById("language_title").innerHTML="Español";	
			document.getElementById("language_jianti").innerHTML="Español";		
		}else if(langs=="fr"){
			document.getElementById("language_title").innerHTML="Français";	
			document.getElementById("language_jianti").innerHTML="Français";		
		}else if(langs=="it"){
			document.getElementById("language_title").innerHTML="Italiano";	
			document.getElementById("language_jianti").innerHTML="Italiano";		
		}else if(langs=="nl"){
			document.getElementById("language_title").innerHTML="Nederlandse";	
			document.getElementById("language_jianti").innerHTML="Nederlandse";		
		}else if(langs=="pt"){
			document.getElementById("language_title").innerHTML="Português";	
			document.getElementById("language_jianti").innerHTML="Português";		
		}else if(langs=="ru"){
			document.getElementById("language_title").innerHTML="Русский";	
			document.getElementById("language_jianti").innerHTML="Русский";		
		}else{
			document.getElementById("language_title").innerHTML="简体中文";	
			document.getElementById("language_jianti").innerHTML="简体中文";			
		}
	...
	var languagejs =function(){
		...
		if(language=="ru"){
				loadJs(document, "ru_ru", "./Public/Wap/Js/lang/ru-ru.js");				
		}else if(language=="tw"){
				loadJs(document, "zh_TW", "./Public/Wap/Js/lang/zh-tw.js");	
		}else if(language=="en"){
				loadJs(document, "en-en", "./Public/Wap/Js/lang/en-en.js");	
		}else if(language=="ja"){
				loadJs(document, "ja-ja", "./Public/Wap/Js/lang/ja.js");	
		}else if(language=="ko"){
				loadJs(document, "ko-ko", "./Public/Wap/Js/lang/ko.js");	
		}else if(language=="de"){
				loadJs(document, "de-de", "./Public/Wap/Js/lang/de.js");	
		}else if(language=="es"){
				loadJs(document, "es-es", "./Public/Wap/Js/lang/es.js");	
		}else if(language=="fr"){
				loadJs(document, "fr-fr", "./Public/Wap/Js/lang/fr.js");	
		}else if(language=="it"){
				loadJs(document, "it-it", "./Public/Wap/Js/lang/it.js");
		}else if(language=="nl"){
				loadJs(document, "nl-nl", "./Public/Wap/Js/lang/nl.js");	
		}else if(language=="pt"){
				loadJs(document, "pt-pt", "./Public/Wap/Js/lang/pt.js");	
		}else{
				loadJs(document, "zh_cn", "./Public/Wap/Js/lang/zh-cn.js");	
		}
	}
//使用条款
var TermsOfUse=function (TO){
	...
	if(TO){
		...
		document.getElementById("home_register").style.display="none";
		document.getElementById("lang_Terms_of_use").innerHTML=TermsOfUses;
...
languagejs();
var setRecommend = function (item) {
	var recommend = userlistobj[item['id']]
	if (!recommend) {
	    userlistobj[item['id']] = item;
	}
}
