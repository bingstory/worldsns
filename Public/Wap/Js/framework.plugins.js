        ...
        var d = {
            ...
            loadImg: function(e, t) {
                ...
                //on() 方法在被选元素及子元素上添加一个或多个事件处理程序。
                    t.call(r)//调用一个对象的一个方法，以另一个对象替换当前对象。 
                });
                r.attr("src", e)
            },
            ...
            destroy: function() {
                ...
                //emoveData()函数用于移除在当前jQuery对象所匹配的每一个元素上存储的指定键名的数据项。 removeData()函数主要用来移除通过data()函数存放的数据
...
/*
	* ScrollIt
 	* ScrollIt.js(scroll鈥t鈥ot鈥s) makes it easy to make long, vertically scrolling pages.
 	*
            ...
            o = {
                ...
                events: {
                    ...
                    addEvent: function(t, n, r) {
                    	//attachEvent和W3C标准的addEventListener绑定多个事件的执行顺序是不一样
            ...
            u = {
                translate: {
                    ...
                    easeCallback: function() {
                        ...
                        //clearInterval(id_of_setinterval)clearInterval() 方法可取消由 setInterval() 设置的 timeout。
						//clearInterval() 方法的参数必须是由 setInterval() 返回的 ID 值。
                        if (i.easingTo === 0) {
                            o.klass.remove(t.body, "snapjs-right");
                            o.klass.remove(t.body, "snapjs-left")
                        }
                        o.dispatchEvent("animated");//dispatchEvent() 方法给节点分派一个合成事件。
...
/*global define, Event, Node*/(function($){	
